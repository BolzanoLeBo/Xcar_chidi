...
#include "interfaces/msg/detail/obstacles__rosidl_typesupport_fastrtps_c.h"
...
using _Obstacles__ros_msg_type = interfaces__msg__Obstacles;
...
size_t get_serialized_size_interfaces__msg__Obstacles(
  const void * untyped_ros_message,
...
static uint32_t _Obstacles__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Obstacles(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Obstacles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Obstacles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Obstacles(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Obstacles)() {
