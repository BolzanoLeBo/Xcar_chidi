...
#include "interfaces/msg/detail/tracking_pos_angle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::TrackingPosAngle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::TrackingPosAngle & ros_message)
{
  // Member: min_angle
  cdr >> ros_message.min_angle;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
max_serialized_size_TrackingPosAngle(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces::msg::TrackingPosAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::TrackingPosAngle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrackingPosAngle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces::msg::TrackingPosAngle *>(
...
static size_t _TrackingPosAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrackingPosAngle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrackingPosAngle__callbacks = {
  "interfaces::msg",
  "TrackingPosAngle",
...
static rosidl_message_type_support_t _TrackingPosAngle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrackingPosAngle__callbacks,
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_TrackingPosAngle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, TrackingPosAngle)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_TrackingPosAngle__handle;
}
