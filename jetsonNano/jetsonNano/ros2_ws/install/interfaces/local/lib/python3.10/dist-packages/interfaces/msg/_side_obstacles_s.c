...
bool interfaces__msg__side_obstacles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._side_obstacles.SideObstacles", full_classname_dest, 44) == 0);
  }
  interfaces__msg__SideObstacles * ros_message = _ros_message;
  {  // left_lidar
...
{
  /* NOTE(esteve): Call constructor of SideObstacles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._side_obstacles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SideObstacles");
