...
interfaces__msg__UserLost__create()
{
  ...
  interfaces__msg__UserLost * msg = (interfaces__msg__UserLost *)allocator.allocate(sizeof(interfaces__msg__UserLost), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(interfaces__msg__UserLost));
  bool success = interfaces__msg__UserLost__init(msg);
  if (!success) {
...
interfaces__msg__UserLost__destroy(interfaces__msg__UserLost * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    interfaces__msg__UserLost__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
interfaces__msg__UserLost__Sequence__init(interfaces__msg__UserLost__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__UserLost * data = NULL;

  if (size) {
    data = (interfaces__msg__UserLost *)allocator.zero_allocate(size, sizeof(interfaces__msg__UserLost), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = interfaces__msg__UserLost__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        interfaces__msg__UserLost__fini(&data[i - 1]);
      }
...
interfaces__msg__UserLost__Sequence__fini(interfaces__msg__UserLost__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      interfaces__msg__UserLost__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__UserLost__Sequence * array = (interfaces__msg__UserLost__Sequence *)allocator.allocate(sizeof(interfaces__msg__UserLost__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = interfaces__msg__UserLost__Sequence__init(array, size);
  if (!success) {
...
interfaces__msg__UserLost__Sequence__destroy(interfaces__msg__UserLost__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    interfaces__msg__UserLost__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
interfaces__msg__UserLost__Sequence__are_equal(const interfaces__msg__UserLost__Sequence * lhs, const interfaces__msg__UserLost__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__UserLost__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  interfaces__msg__UserLost__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__UserLost);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__msg__UserLost * data =
      (interfaces__msg__UserLost *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__UserLost__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__msg__UserLost__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__msg__UserLost__copy(
